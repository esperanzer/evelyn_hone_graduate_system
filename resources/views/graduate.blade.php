            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="infor_status" class="col-md-4 col-form-label text-md-right">{{ __('infor_status') }}</label>

                            <div class="col-md-6">
                                <input id="infor_status" type="infor_status" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
...
Student ID</th>
      ...
      <th class="col-md-3 col-xs-3">Dept</th>
      <th class="col-md-3 col-xs-3">infor Status</th>
      <th class="col-md-3 col-xs-3">Phone number</th>
      <th class="col-md-3 col-xs-3">Graduate Year</th>
